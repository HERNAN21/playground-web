        ...
        <div className="navbar-inner">
          <Collapse navbar isOpen={true}>
            ...
            <Nav className="mb-md-3" navbar>
              <NavItem>
                <NavLink
                  href="http://ec2-3-94-49-11.compute-1.amazonaws.com/app_citas"
                  target="_blank">
                  <i className="ni ni-palette" />
                  <span className="nav-link-text">Control de acceso</span>
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink
                  href="http://ec2-3-94-49-11.compute-1.amazonaws.com/portal_industrial"
                  target="_blank">
                  <i className="ni ni-palette" />
                  <span className="nav-link-text">Portal industrial</span>
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink
                  href="https://webqa-dot-pe-gromero-ransa-gcp.appspot.com/"
                  target="_blank">
                  <i className="ni ni-ui-04" />
                  <span className="nav-link-text">Portal extractivos</span>
                </NavLink>
              </NavItem>
              {/* <NavItem>
                <NavLink
