      ...
      <>
        <Navbar
          className={classnames(
            ...
            { "navbar-dark ransa-bg-info": this.props.theme === "dark" },
                  ...
                  >
                    <Row className="shortcuts px-4">
                      ...
                      <Col
                        ...
                        tag="a"
                      >
                        <span className="shortcut-media avatar rounded-circle ransa-bg-gradient-info">
                  ...
                  <DropdownToggle className="nav-link pr-0" color="" tag="a">
                    <Media className="align-items-center">
                      ...
                      <Media className="ml-2 d-none d-lg-block">
                        ...
                        {this.recursoSession.nombres}{" "}
                        {this.recursoSession.ape_paterno}
                        </span>
                      </Media>
                    </Media>
                  </DropdownToggle>
